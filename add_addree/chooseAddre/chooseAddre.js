...
toModifyAddre:function(e){
  console.log("x" + e.currentTarget.dataset.name);
...
toCleanOrder:function(e){
  for(var i = 0;i<this.data.list.length;i++){
    if(i==e.currentTarget.dataset.index){
      li[e.currentTarget.dataset.index].image = "http://www.lrmnd.top//qhbs/images/person/addree/check.jpg"}
  else{
      li[i].image = "http://www.lrmnd.top//qhbs/images/person/addree/uncheck.png"
  }
}
	wx.navigateTo({
     ...
     console.log("姓名为："+e.currentTarget.dataset.name+"，手机是："+e.currentTarget.dataset.tel+"，地址是："+e.currentTarget.dataset.addre+"，街道是："+e.currentTarget.dataset.area+"，是否选择是："+e.currentTarget.dataset.index);
},
  ...
  onLoad: function(options) {
    ...
    if (flag) {
      ...
      "index":index++,
    	...
    	"area":options.area,
      "image":"http://www.lrmnd.top//qhbs/images/person/addree/uncheck.png",
